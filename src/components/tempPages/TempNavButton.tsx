...
const NavButton: React.FC<NavButtonProps> = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`flex-none  relative w-218 h-60 flex items-center justify-center select-none outline-none ${className} `}
    ...
    >
      ...
      <span
        className={`z-10 text-body-1 ${
          active ? "text-background-white font-700" : "font-400"
        }`}
        style={{
          fontSize: `${15 * scale}px`,
          lineHeight: `${18 * scale}px`,
          color: active ? undefined : "#DED5D5",
        }}
      >
        {label}
      </span>
